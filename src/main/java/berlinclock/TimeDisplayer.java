...
public class TimeDisplayer {
    ...
    public String toString() {
        if (withColors) {
            return getSecondStringColored() + '\n' +
                    getFiveBlockHourStringColored() + '\n' +
                    getSingleBlockHourStringColored() + '\n' +
                    getFiveBlockMinuteStringColored() + '\n' +
                    getSingleBlockMinuteStringColored() + '\n';
        } else {
